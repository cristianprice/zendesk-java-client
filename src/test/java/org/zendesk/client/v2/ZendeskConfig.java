...
public final class ZendeskConfig {
    ...
    /**
     * Reads variables from a properties file, or if none found, reads from
     * environment variables Environment variables should have a prefix,
     * "ZENDESK_JAVA_CLIENT_TEST_" to be properly used
     * 
